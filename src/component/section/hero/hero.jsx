...
const MySlider = () => (
    <Carousel autoPlay showThumbs = {false} showStatus = {false}>
      <div>
        <img src={'assets/images/banner/main-banner-mobile.png'} alt="Slide 1" />
      </div>
      {/* <div>
  ...
  const MySliderWeb = () => (
    <Carousel autoPlay showThumbs = {false} showStatus = {false}>
      <div>
        <img src={'/assets/images/banner/main-banner.png'} alt="Slide 1" />
      </div>
      {/* <div>
        <img src={'/assets/images/banner/main-banner.png'} alt="Slide 2" />
      </div> */}
...
const HeroThree = () => {
    ...
    return (
        ...
        <section id="home" className="slider-area slider-four fix p-relative  pb-10" style={{paddingTop:'100px'}}>
        ...
        :
        web ?
        <section id="home" className="slider-area slider-four fix p-relative pb-1" style={{paddingTop:'180px'}}>
