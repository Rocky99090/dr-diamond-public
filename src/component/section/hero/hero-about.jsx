...
const openWhatsapp = () => {
  window.location.href = "https://wa.link/diamondexchange"
}

const MySlider = () => (
    <Carousel autoPlay showThumbs = {false} showStatus = {false}>
      <div onClick={openWhatsapp}>
        <img src={'assets/images/banner/about1-mobile.webp'} alt="Slide 1" />
      </div>
      {/* <div>
  ...
  const MySliderWeb = () => (
    <Carousel autoPlay showThumbs = {false} showStatus = {false}>
      <div onClick={openWhatsapp}>
        <img src={'/assets/images/banner/about1.png'} alt="Slide 1" />
      </div>
      {/* <div>
        <img src={'/assets/images/banner/main-banner.png'} alt="Slide 2" />
      </div> */}
